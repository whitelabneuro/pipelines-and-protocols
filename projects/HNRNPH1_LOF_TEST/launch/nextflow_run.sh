#!/bin/bash -l
#SBATCH --job-name=HNRNPH1_LOF_TEST
...
#SBATCH --output=/scratch/prj/bcn_whitema_rbp/HNRNPH1_LOF_TEST/logs/%x-%j.out
#SBATCH --error=/scratch/prj/bcn_whitema_rbp/HNRNPH1_LOF_TEST/logs/%x-%j.err
